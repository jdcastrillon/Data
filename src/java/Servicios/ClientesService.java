...
public class ClientesService implements Serializable {
    ...
    public Object[] Transaccion(Clientes obj, String accion) {
        ...
        try {
            ...
            if (accion.equalsIgnoreCase("Nuevo")) {
                ...
                obj.setCod_cliente(Service.service.logProceso("clientes").intValue());
            }
            transacciones.add(Service.service.log("Clientes", login.getUsuario(), accion, logproceso.intValue(), login.getBase()));
...
//            }
    ...
    public Object[] recuperarInfo(Clientes obj) {
        Object Resulta[] = new Object[2];

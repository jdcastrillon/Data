...
import Modelo.Compras.PagosProv;
import Modelo.Compras.PagosProvDT;
 ...
 * @author LENOVO
 */
@Named(value = "pagosproveedorservice")
@ApplicationScoped
public class PagosProveedorService implements Serializable {
     ...
     */
    public PagosProveedorService() {
    }

    public Object[] Transaccion(PagosProv obj, String accion) {
...
//            obj.setSigno(obj.getSigno() == 0 ? 1 : -1);
            ...
            //Detalle
            int linea = 1;
            for (PagosProvDT facturas : obj.getFacturas()) {
                facturas.setTrans(obj.getTrans());
...
//        }
    ...
    public List<PagosProv> ListaBusqueda(String busqueda) {
...
//        }
    ...
    public Object[] recuperarInfo(PagosProv obj) {
...
//            if (!jsonElement.getAsString().equalsIgnoreCase("No hay Datos")) {
//                PagosProvDT obj2 = new PagosProvDT();
//                Map<String, Object> map = gson.fromJson(jsonElement.getAsString(), new TypeToken<Map<String, Object>>() {
//                }.getType());
//
